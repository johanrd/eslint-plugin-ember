...
| [template-mouse-events-have-key-events](docs/rules/template-mouse-events-have-key-events.md)                     | require mouseover/mouseout to be accompanied by focus/blur for keyboard-only users |    |    |    |
