...
| Name                                                                                                             | Description                                                                      | 💼                              | 🔧 | 💡 |
| :--------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------- | :------------------------------ | :- | :- |
| [template-link-href-attributes](docs/rules/template-link-href-attributes.md)                                     | require href attribute on link elements                                          | ![badge-recommended-template][] |    |    |
| [template-no-abstract-roles](docs/rules/template-no-abstract-roles.md)                                           | disallow abstract ARIA roles                                                     | ![badge-recommended-template][] |    |    |
| [template-no-accesskey-attribute](docs/rules/template-no-accesskey-attribute.md)                                 | disallow accesskey attribute                                                     | ![badge-recommended-template][] | 🔧 |    |
| [template-no-aria-hidden-body](docs/rules/template-no-aria-hidden-body.md)                                       | disallow aria-hidden on body element                                             | ![badge-recommended-template][] | 🔧 |    |
| [template-no-aria-unsupported-elements](docs/rules/template-no-aria-unsupported-elements.md)                     | disallow ARIA roles, states, and properties on elements that do not support them | ![badge-recommended-template][] |    |    |
| [template-no-autofocus-attribute](docs/rules/template-no-autofocus-attribute.md)                                 | disallow autofocus attribute                                                     | ![badge-recommended-template][] | 🔧 |    |
| [template-no-duplicate-landmark-elements](docs/rules/template-no-duplicate-landmark-elements.md)                 | disallow duplicate landmark elements without unique labels                       | ![badge-recommended-template][] |    |    |
| [template-no-empty-headings](docs/rules/template-no-empty-headings.md)                                           | disallow empty heading elements                                                  | ![badge-recommended-template][] |    |    |
| [template-no-heading-inside-button](docs/rules/template-no-heading-inside-button.md)                             | disallow heading elements inside button elements                                 | ![badge-recommended-template][] |    |    |
| [template-no-invalid-aria-attributes](docs/rules/template-no-invalid-aria-attributes.md)                         | disallow invalid aria-* attributes                                               | ![badge-recommended-template][] |    |    |
| [template-no-invalid-interactive](docs/rules/template-no-invalid-interactive.md)                                 | disallow non-interactive elements with interactive handlers                      | ![badge-recommended-template][] |    |    |
| [template-no-invalid-link-text](docs/rules/template-no-invalid-link-text.md)                                     | disallow invalid or uninformative link text content                              | ![badge-recommended-template][] |    |    |
| [template-no-invalid-link-title](docs/rules/template-no-invalid-link-title.md)                                   | disallow invalid title attributes on link elements                               | ![badge-recommended-template][] |    |    |
| [template-no-invalid-role](docs/rules/template-no-invalid-role.md)                                               | disallow invalid ARIA roles                                                      | ![badge-recommended-template][] |    |    |
| [template-no-nested-interactive](docs/rules/template-no-nested-interactive.md)                                   | disallow nested interactive elements                                             | ![badge-recommended-template][] |    |    |
| [template-no-nested-landmark](docs/rules/template-no-nested-landmark.md)                                         | disallow nested landmark elements                                                | ![badge-recommended-template][] |    |    |
| [template-no-pointer-down-event-binding](docs/rules/template-no-pointer-down-event-binding.md)                   | disallow pointer down event bindings                                             | ![badge-recommended-template][] |    |    |
| [template-no-positive-tabindex](docs/rules/template-no-positive-tabindex.md)                                     | disallow positive tabindex values                                                | ![badge-recommended-template][] |    |    |
| [template-no-redundant-role](docs/rules/template-no-redundant-role.md)                                           | disallow redundant role attributes                                               | ![badge-recommended-template][] | 🔧 |    |
| [template-no-unsupported-role-attributes](docs/rules/template-no-unsupported-role-attributes.md)                 | disallow ARIA attributes that are not supported by the element role              | ![badge-recommended-template][] | 🔧 |    |
| [template-no-whitespace-within-word](docs/rules/template-no-whitespace-within-word.md)                           | disallow excess whitespace within words (e.g. "W e l c o m e")                   | ![badge-recommended-template][] |    |    |
| [template-require-aria-activedescendant-tabindex](docs/rules/template-require-aria-activedescendant-tabindex.md) | require non-interactive elements with aria-activedescendant to have tabindex     | ![badge-recommended-template][] | 🔧 |    |
| [template-require-context-role](docs/rules/template-require-context-role.md)                                     | require ARIA roles to be used in appropriate context                             | ![badge-recommended-template][] |    |    |
| [template-require-iframe-title](docs/rules/template-require-iframe-title.md)                                     | require iframe elements to have a title attribute                                | ![badge-recommended-template][] |    |    |
| [template-require-input-label](docs/rules/template-require-input-label.md)                                       | require label for form input elements                                            | ![badge-recommended-template][] |    |    |
| [template-require-lang-attribute](docs/rules/template-require-lang-attribute.md)                                 | require lang attribute on html element                                           | ![badge-recommended-template][] |    |    |
| [template-require-mandatory-role-attributes](docs/rules/template-require-mandatory-role-attributes.md)           | require mandatory ARIA attributes for ARIA roles                                 | ![badge-recommended-template][] |    |    |
| [template-require-media-caption](docs/rules/template-require-media-caption.md)                                   | require captions for audio and video elements                                    | ![badge-recommended-template][] |    |    |
| [template-require-presentational-children](docs/rules/template-require-presentational-children.md)               | require presentational elements to only contain presentational children          | ![badge-recommended-template][] |    |    |
| [template-require-valid-alt-text](docs/rules/template-require-valid-alt-text.md)                                 | require valid alt text for images and other elements                             | ![badge-recommended-template][] |    |    |
...
| [template-table-groups](docs/rules/template-table-groups.md)                                                     | require table elements to use table grouping elements                            | ![badge-recommended-template][] |    |    |

### Best Practices

| Name                                                                                                               | Description                                                                  | 💼                              | 🔧 | 💡 |
| :----------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- | :------------------------------ | :- | :- |
| [template-builtin-component-arguments](docs/rules/template-builtin-component-arguments.md)                         | disallow setting certain attributes on builtin components                    | ![badge-recommended-template][] |    |    |
| [template-no-action-modifiers](docs/rules/template-no-action-modifiers.md)                                         | disallow usage of {{action}} modifiers                                       |                                 | 🔧 |    |
| [template-no-action-on-submit-button](docs/rules/template-no-action-on-submit-button.md)                           | disallow action attribute on submit buttons                                  | ![badge-recommended-template][] |    |    |
| [template-no-args-paths](docs/rules/template-no-args-paths.md)                                                     | disallow args.foo paths in templates, use @foo instead                       | ![badge-recommended-template][] | 🔧 |    |
| [template-no-arguments-for-html-elements](docs/rules/template-no-arguments-for-html-elements.md)                   | disallow @arguments on HTML elements                                         | ![badge-recommended-template][] |    |    |
| [template-no-array-prototype-extensions](docs/rules/template-no-array-prototype-extensions.md)                     | disallow usage of Ember Array prototype extensions                           | ![badge-recommended-template][] | 🔧 |    |
| [template-no-at-ember-render-modifiers](docs/rules/template-no-at-ember-render-modifiers.md)                       | disallow usage of @ember/render-modifiers                                    | ![badge-recommended-template][] |    |    |
...
| [template-no-block-params-for-html-elements](docs/rules/template-no-block-params-for-html-elements.md)             | disallow block params on HTML elements                                       | ![badge-recommended-template][] |    |    |
| [template-no-builtin-form-components](docs/rules/template-no-builtin-form-components.md)                           | disallow usage of built-in form components                                   | ![badge-recommended-template][] |    |    |
| [template-no-capital-arguments](docs/rules/template-no-capital-arguments.md)                                       | disallow capital arguments (use lowercase @arg instead of @Arg)              | ![badge-recommended-template][] |    |    |
| [template-no-chained-this](docs/rules/template-no-chained-this.md)                                                 | disallow redundant `this.this` in templates                                  |                                 | 🔧 |    |
| [template-no-class-bindings](docs/rules/template-no-class-bindings.md)                                             | disallow passing classBinding or classNameBindings as arguments in templates | ![badge-recommended-template][] |    |    |
| [template-no-curly-component-invocation](docs/rules/template-no-curly-component-invocation.md)                     | disallow curly component invocation, use angle bracket syntax instead        | ![badge-recommended-template][] | 🔧 |    |
| [template-no-debugger](docs/rules/template-no-debugger.md)                                                         | disallow {{debugger}} in templates                                           | ![badge-recommended-template][] |    |    |
| [template-no-duplicate-attributes](docs/rules/template-no-duplicate-attributes.md)                                 | disallow duplicate attribute names in templates                              | ![badge-recommended-template][] | 🔧 |    |
| [template-no-duplicate-id](docs/rules/template-no-duplicate-id.md)                                                 | disallow duplicate id attributes                                             | ![badge-recommended-template][] |    |    |
...
| [template-no-forbidden-elements](docs/rules/template-no-forbidden-elements.md)                                     | disallow specific HTML elements                                              | ![badge-recommended-template][] |    |    |
| [template-no-html-comments](docs/rules/template-no-html-comments.md)                                               | disallow HTML comments in templates                                          | ![badge-recommended-template][] | 🔧 |    |
| [template-no-implicit-this](docs/rules/template-no-implicit-this.md)                                               | require explicit `this` in property access                                   | ![badge-recommended-template][] |    |    |
| [template-no-index-component-invocation](docs/rules/template-no-index-component-invocation.md)                     | disallow index component invocations                                         | ![badge-recommended-template][] |    |    |
...
| [template-no-inline-styles](docs/rules/template-no-inline-styles.md)                                               | disallow inline styles                                                       | ![badge-recommended-template][] |    |    |
| [template-no-input-block](docs/rules/template-no-input-block.md)                                                   | disallow block usage of {{input}} helper                                     | ![badge-recommended-template][] |    |    |
| [template-no-input-tagname](docs/rules/template-no-input-tagname.md)                                               | disallow tagName attribute on {{input}} helper                               | ![badge-recommended-template][] |    |    |
| [template-no-invalid-meta](docs/rules/template-no-invalid-meta.md)                                                 | disallow invalid meta tags                                                   | ![badge-recommended-template][] |    |    |
| [template-no-log](docs/rules/template-no-log.md)                                                                   | disallow {{log}} in templates                                                | ![badge-recommended-template][] |    |    |
...
| [template-no-nested-splattributes](docs/rules/template-no-nested-splattributes.md)                                 | disallow nested ...attributes usage                                          | ![badge-recommended-template][] |    |    |
| [template-no-obscure-array-access](docs/rules/template-no-obscure-array-access.md)                                 | disallow obscure array access patterns like `objectPath.@each.property`      | ![badge-recommended-template][] | 🔧 |    |
| [template-no-obsolete-elements](docs/rules/template-no-obsolete-elements.md)                                       | disallow obsolete HTML elements                                              | ![badge-recommended-template][] |    |    |
| [template-no-outlet-outside-routes](docs/rules/template-no-outlet-outside-routes.md)                               | disallow {{outlet}} outside of route templates                               | ![badge-recommended-template][] |    |    |
| [template-no-page-title-component](docs/rules/template-no-page-title-component.md)                                 | disallow usage of ember-page-title component                                 |                                 |    |    |
| [template-no-passed-in-event-handlers](docs/rules/template-no-passed-in-event-handlers.md)                         | disallow passing event handlers directly as component arguments              | ![badge-recommended-template][] |    |    |
| [template-no-positional-data-test-selectors](docs/rules/template-no-positional-data-test-selectors.md)             | disallow positional data-test-* params in curly invocations                  | ![badge-recommended-template][] | 🔧 |    |
| [template-no-potential-path-strings](docs/rules/template-no-potential-path-strings.md)                             | disallow potential path strings in attribute values                          | ![badge-recommended-template][] |    |    |
| [template-no-redundant-fn](docs/rules/template-no-redundant-fn.md)                                                 | disallow unnecessary usage of (fn) helper                                    | ![badge-recommended-template][] | 🔧 |    |
...
| [template-no-unnecessary-component-helper](docs/rules/template-no-unnecessary-component-helper.md)                 | disallow unnecessary component helper                                        | ![badge-recommended-template][] | 🔧 |    |
| [template-no-unnecessary-concat](docs/rules/template-no-unnecessary-concat.md)                                     | disallow unnecessary string concatenation                                    |                                 | 🔧 |    |
| [template-no-unnecessary-curly-parens](docs/rules/template-no-unnecessary-curly-parens.md)                         | disallow unnecessary parentheses enclosing statements in curlies             | ![badge-recommended-template][] | 🔧 |    |
| [template-no-unused-block-params](docs/rules/template-no-unused-block-params.md)                                   | disallow unused block parameters in templates                                | ![badge-recommended-template][] |    |    |
| [template-no-valueless-arguments](docs/rules/template-no-valueless-arguments.md)                                   | disallow valueless named arguments                                           | ![badge-recommended-template][] |    |    |
| [template-no-whitespace-for-layout](docs/rules/template-no-whitespace-for-layout.md)                               | disallow using whitespace for layout purposes                                | ![badge-recommended-template][] |    |    |
...
| [template-no-yield-only](docs/rules/template-no-yield-only.md)                                                     | disallow components that only yield                                          | ![badge-recommended-template][] |    |    |
| [template-no-yield-to-default](docs/rules/template-no-yield-to-default.md)                                         | disallow yield to default block                                              | ![badge-recommended-template][] |    |    |
| [template-require-button-type](docs/rules/template-require-button-type.md)                                         | require button elements to have a valid type attribute                       | ![badge-recommended-template][] | 🔧 |    |
...
| [template-require-has-block-helper](docs/rules/template-require-has-block-helper.md)                               | require (has-block) helper usage instead of hasBlock property                | ![badge-recommended-template][] | 🔧 |    |
...
| [template-require-valid-named-block-naming-format](docs/rules/template-require-valid-named-block-naming-format.md) | require valid named block naming format                                      | ![badge-recommended-template][] | 🔧 |    |
...
| [template-simple-modifiers](docs/rules/template-simple-modifiers.md)                                               | require simple modifier syntax                                               | ![badge-recommended-template][] |    |    |
| [template-simple-unless](docs/rules/template-simple-unless.md)                                                     | require simple conditions in unless blocks                                   | ![badge-recommended-template][] | 🔧 |    |
| [template-sort-invocations](docs/rules/template-sort-invocations.md)                                               | require sorted attributes and modifiers                                      |                                 | 🔧 |    |
| [template-splat-attributes-only](docs/rules/template-splat-attributes-only.md)                                     | disallow ...spread other than ...attributes                                  | ![badge-recommended-template][] |    |    |
| [template-style-concatenation](docs/rules/template-style-concatenation.md)                                         | disallow string concatenation in inline styles                               | ![badge-recommended-template][] |    |    |
...
| [template-deprecated-inline-view-helper](docs/rules/template-deprecated-inline-view-helper.md)   | disallow inline {{view}} helper                           | ![badge-recommended-template][] | 🔧 |    |
| [template-deprecated-render-helper](docs/rules/template-deprecated-render-helper.md)             | disallow {{render}} helper                                | ![badge-recommended-template][] | 🔧 |    |
| [template-no-action](docs/rules/template-no-action.md)                                           | disallow {{action}} helper                                | ![badge-recommended-template][] |    |    |
| [template-no-attrs-in-components](docs/rules/template-no-attrs-in-components.md)                 | disallow attrs in component templates                     | ![badge-recommended-template][] |    |    |
| [template-no-link-to-positional-params](docs/rules/template-no-link-to-positional-params.md)     | disallow positional params in LinkTo component            | ![badge-recommended-template][] |    |    |
| [template-no-link-to-tagname](docs/rules/template-no-link-to-tagname.md)                         | disallow tagName attribute on LinkTo component            | ![badge-recommended-template][] |    |    |
| [template-no-route-action](docs/rules/template-no-route-action.md)                               | disallow usage of route-action helper                     | ![badge-recommended-template][] |    |    |
| [template-no-unbound](docs/rules/template-no-unbound.md)                                         | disallow {{unbound}} helper                               | ![badge-recommended-template][] |    |    |
| [template-no-with](docs/rules/template-no-with.md)                                               | disallow {{with}} helper                                  | ![badge-recommended-template][] |    |    |
...
| Name                                                                                                                       | Description                                                       | 💼                              | 🔧 | 💡 |
| :------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------- | :------------------------------ | :- | :- |
| [template-no-extra-mut-helper-argument](docs/rules/template-no-extra-mut-helper-argument.md)                               | disallow passing more than one argument to the mut helper         | ![badge-recommended-template][] |    |    |
| [template-no-jsx-attributes](docs/rules/template-no-jsx-attributes.md)                                                     | disallow JSX-style camelCase attributes                           |                                 | 🔧 |    |
| [template-no-scope-outside-table-headings](docs/rules/template-no-scope-outside-table-headings.md)                         | disallow scope attribute outside th elements                      | ![badge-recommended-template][] |    |    |
| [template-no-shadowed-elements](docs/rules/template-no-shadowed-elements.md)                                               | disallow ambiguity with block param names shadowing HTML elements | ![badge-recommended-template][] |    |    |
| [template-no-unbalanced-curlies](docs/rules/template-no-unbalanced-curlies.md)                                             | disallow unbalanced mustache curlies                              | ![badge-recommended-template][] |    |    |
| [template-no-unknown-arguments-for-builtin-components](docs/rules/template-no-unknown-arguments-for-builtin-components.md) | disallow unknown arguments for built-in components                | ![badge-recommended-template][] |    |    |
...
| Name                                                                   | Description                                                     | 💼                              | 🔧 | 💡 |
| :--------------------------------------------------------------------- | :-------------------------------------------------------------- | :------------------------------ | :- | :- |
| [template-link-rel-noopener](docs/rules/template-link-rel-noopener.md) | require rel="noopener noreferrer" on links with target="_blank" | ![badge-recommended-template][] | 🔧 |    |
| [template-no-triple-curlies](docs/rules/template-no-triple-curlies.md) | disallow usage of triple curly brackets (unescaped variables)   | ![badge-recommended-template][] |    |    |
...
| Name                                                                                         | Description                                                | 💼                              | 🔧 | 💡 |
| :------------------------------------------------------------------------------------------- | :--------------------------------------------------------- | :------------------------------ | :- | :- |
| [template-no-quoteless-attributes](docs/rules/template-no-quoteless-attributes.md)           | require quotes on all attribute values                     | ![badge-recommended-template][] | 🔧 |    |
| [template-no-unnecessary-curly-strings](docs/rules/template-no-unnecessary-curly-strings.md) | disallow unnecessary curly braces in string interpolations | ![badge-recommended-template][] | 🔧 |    |
